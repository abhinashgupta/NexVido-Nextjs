...
import { homeLinks, subscriptions, categories } from "../constants";
import { menuActions, categoryActions } from "../redux/store";
import { useSelector, useDispatch } from "react-redux";


const GotoPage = ({ Icon, heading, onClick, styles, imgIcon }) => (
  <div
    style={styles}
    onClick={onClick}
  ...
  >
    <div className="">
      ...
      {imgIcon && <img className="w-[24px] rounded-lg" src={imgIcon} alt="icon"/>}
    </div>
  ...
  return (    
    ...
    >
      ...
      >
        ...
        <div className="mt-4 w-[95%] h-[1px] self-center bg-slate-500">
          <h1 className="opacity-0">.</h1>
        </div>
